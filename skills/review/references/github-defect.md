# GitHub Copilot Defect bar (verbatim)

Source: `@github/copilot` `definitions/code-review.agent.yaml`  
(`AppData/Roaming/npm/node_modules/@github/copilot/definitions/code-review.agent.yaml`)

Do not paraphrase this bar. Do not add style/smell items here.
...
Tools for investigation only (git, read, grep, glob, build, tests). Do not edit or create files.
