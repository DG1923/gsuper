...
User-owned. The agent may **propose** a change; it writes this file only after you approve the exact edit.

Must / must-not for **this** repo (not gsuper plugin rules).
"""
